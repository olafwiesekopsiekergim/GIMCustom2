...
Report 60015 "CCO Sales Prepayment Invoice"
{
    Caption = 'Sales Prepayment Invoice';
    Permissions = TableData "Sales Invoice Header" = r;
    WordLayout = './Layouts/CCOSalesPrepaymentInvoice.docx';
    DefaultLayout = Word;
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(DUE024; DUE024 + ' ' + SalesInv."No.")
                    {
                    }
                    ...
                    dataitem("Sales Line"; "Sales Line")
                    {
                        ...
                        column(InvDiscPercent2; InvDiscPercent)
                        {
                        }
                        trigger OnPreDataItem();
                        begin
                        ...
                        trigger OnAfterGetRecord();
                        begin
                            SalesLine.CalcSums("Prepayment Amount", "Prepmt. Amt. Incl. VAT");
                            SalesLine.CalcSums("Inv. Discount Amount");
                            "Sales Header".Get("Document Type", "Document No.");
                            //TotalSalesLine."Inv. Discount Amount" := SalesCalcDiscByType.GetCustInvoiceDiscountAmt("Sales Header", InvDiscPercent);
                            TotalSalesLine."Inv. Discount Amount" := GetCustInvoiceDiscountAmt("Sales Header", InvDiscPercent);
                            //SalesHeader.GET("Document Type","Document No.");
                            SalesInvoiceLine.SetRange("No.", SalesInv."No.");
                            SalesInvoiceLine.Get(SalesInv."No.");
                            SalesInvoiceLine.CalcSums(Amount, "Amount Including VAT", "VAT Base Amount");
                        end;
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(STRSUBSTNO_DUE011_FORMAT_SalesLineLineDiscountPct_; StrSubstNo(DUE011))
                        {
                        }
                        ...
                        column(SalesLineLineAmount_SalesLineInvDiscountAmount_VATAmount; SalesLine."Line Amount" + VATAmount)
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(SalesLineLineAmount_SalesLineInvDiscountAmount; SalesLine."Prepayment Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(LineDiscount; SalesLine."Line Discount %")
                        {
                        }
                        ...
                        begin
                            ...
                            Total1 += SalesLine."Prepayment Amount";
                            VATTEST += SalesLine."Prepmt. Amount Inv. Incl. VAT" - SalesLine."Prepayment Amount";
                            Total2 += SalesLine."Prepmt. Amount Inv. Incl. VAT";
                            Total3 += "Sales Line"."Prepayment Amount";
                        end;
                ...
                begin
                    ...
                    VATAmount := "Sales Line"."Line Amount" / 100 * 19;
            ...
            begin
                ...
                // <<AT
                SalesInv.SetRange("Prepayment Order No.", "Sales Header"."No.");
                SalesMemo.SetRange("Prepayment Order No.", "Sales Header"."No.");
                if
                SalesInv.Count = SalesMemo.Count then
                    Error('Keine Vorrauszahlungsrechnung verfügbar!')
                else
                    SalesInv.FindLast;
    ...
    var
        ...
        DUE024: label ' Prepayment Invoice';
    ...
    local procedure GetCustInvoiceDiscountAmt(SalesHeader: Record "Sales Header"; InvDiscoutPct: Decimal): Decimal
    begin
        IF InvDiscoutPct = 0 THEN
            EXIT(0);

        WITH SalesHeader DO BEGIN
            CALCFIELDS("Amount Including VAT", Amount);
            IF "Prices Including VAT" THEN
                EXIT(ROUND(("Amount Including VAT" + "Invoice Discount Value") * (InvDiscoutPct / 100), 0.01));

            EXIT(ROUND((Amount + "Invoice Discount Value") * (InvDiscoutPct / 100), 0.01));
        END;
    end;
    ...
    begin
        with RoundLoop do begin
            ...
            if ReportForNavShowOutput and not "Sales Header"."Pos.-Zus.-Zähl-Summen drucken" and not "Sales Header"."Zeilenrabatt ausblenden" then begin
                AusgVKPreis := ("Sales Line"."Prepayment Amount" + "Sales Line"."Inv. Discount Amount") / "Sales Line".Quantity;
                AusgBetragRechnsUndRabBetrag := ("Sales Line"."Prepayment Amount" + "Sales Line"."Inv. Discount Amount");
                AusgWährTxt := WährTxt;
            end
            else
    ...
    begin
        with RoundLoop do begin
            ...
            if ReportForNavShowOutput and not "Sales Header"."Pos.-Zus.-Zähl-Summen drucken" and not "Sales Header"."Zeilenrabatt ausblenden" then begin
                ...
                AusgBetragRechnsUndRabBetrag := "Sales Line"."Prepmt. Line Amount";
                AusgWährTxt := WährTxt;
            end;
            if ReportForNavShowOutput and "Sales Header"."Zeilenrabatt ausblenden" then begin
                AusgVKPreis := "Sales Line"."Unit Price" - ("Sales Line"."Line Discount Amount" / "Sales Line".Quantity);
                AusgBetragRechnsUndRabBetrag := "Sales Line"."Prepmt. Line Amount";
                AusgWährTxt := WährTxt;
            end;
        end;
    ...
    begin
        with RoundLoop do begin
            ReportForNavSetShowOutput(("Sales Line"."Line Discount %" <> 0) and
                                  not FrachtJN and not ("Sales Header"."Zeilenrabatt ausblenden"));
        end;
    end;
    ...
    begin
        with RoundLoop do begin
            ReportForNavSetShowOutput(false);//(SalesLine."Inv. Discount Amount" <> 0);
        end;
    end;
    ...
    begin
        ...
        case (dataItemId) of
            ...
            'SalesLine':
                begin
                    values := 'SalesHeader';
                    ReportForNav.AddAdditionalValues(jsonObject, values, "Sales Header");
                end;
            'RoundLoop':
                begin
                    values := 'SalesLine';
