...
Report 60001 "CCO Sales Quote"
{
    Caption = 'Sales Quote';
    WordLayout = './Layouts/CCOSalesQuote.docx';
    DefaultLayout = Word;
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(EMail_SalesPerchPerson; SalesPurchPerson."E-Mail")
                    {
                    ...
                    column(SalesHeaderAngebotsbindefrist; "Sales Header"."Quote Expiration Date")
                    {
                        IncludeCaption = false;
                    }
                    ...
                    column(EMail_BenutzerER; Kundendienst."E-Mail")
                    {
                        IncludeCaption = false;
                    }
                    ...
                    column(KundendienstName; Kundendienst.Name)
                    {
                        IncludeCaption = false;
                    }
                    ...
                    column(KundendienstTelefon; Kundendienst."Phone No.")
                    {
                        IncludeCaption = false;
                    }
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(SalesLineAlternPosition; SalesLine."CCS PR Special Position")
                        {
                            IncludeCaption = false;
                        }
                        ...
                        column(STRSUBSTNO_DUE011_SalesHeaderInvoiceDiscCode; StrSubstNo(DUE023))
                        {
                        }
                                ...
                                "Sales Line".Type::Item:
                                    begin
                                        if not Item.Get("Sales Line"."No.") then
                                            Item.Init;
                                        if ((Item.Abmessung1 <> '') and (Item.Abmessung2 <> '') and (Item.Abmessung3 <> '')) then
                                            ArtInfoAbm := StrSubstNo(DUE060, Item.Abmessung1, Item.Abmessung2, Item.Abmessung3)
                                        else
                                            ArtInfoAbm := '';
                                    end;
                            end;
                    ...
                    dataitem(Total; Integer)
                    {
                        ...
                        column(DUE017; DUE017)
                        {
                            IncludeCaption = false;
                        }
                        column(DUE050; DUE050)
                        {
                            IncludeCaption = false;
                        }
                ...
                begin
                    ...
                    //ELSE
                    ///SalesPost.SQ_GetSalesLines("Sales Header",SalesLine,0);
            ...
            begin
                ...
                if RespCenter.Get("Responsibility Center") then begin
                    ...
                    FirmenAnschr1 := CompanyInfo.Name;
                ...
                if not BenutzerER.Get(Creationuser) then
                    Clear(BenutzerER);
                if not DebitorR.Get("Sales Header"."Sell-to Customer No.") then
                    DebitorR.Init;
                //c/gw/160502: - Stichwort: PositonsZusammenzählung
    ...
    var
        ...
        DUE020: label 'Our general terms and conditions of sale apply. Errors excepted, technical changes subject to change without notice.';
        DUE021: label 'You will find our gerneral terms and conditions following www.dueperthal.com or receive them by e-mail upon request.';
        DUE022: label 'Our tip: Web-enquiry with www.dueperthal.com. Every click pays!';
        Comment_VerkaufsbemerkungVor: Record "Sales Comment Line";
        ...
        DUE023: label 'Discount';
        DUE050: label '* Item is not eligible for discount';
        DUE040: label 'Sum Position';
        DUE060: label 'Dim.[mm]  %1 x %2 x %3 (W x D x H)';
    ...
    begin
        //c/gw/160502: - Stichwort: PositonsZusammenzählung
        ZeilenDuplikatRecSet."Document Type" := ZeilenDuplikatRecSet."document type"::Quote;
    ...
    local procedure OnPreSectionDimensionLoop1_Body11(var DimensionLoop1: Record Integer);
    begin
        with DimensionLoop1 do begin
            ReportForNavSetShowOutput(Number > 1);
        end;
    ...
    local procedure OnPreSectionRoundLoop_TransHeader14(var RoundLoop: Record Integer);
    begin
    ...
    begin
        with RoundLoop do begin
            ...
            AusgWährTxt := '';
            if ReportForNavShowOutput and not "Sales Header"."Pos.-Zus.-Zähl-Summen drucken" then begin
                AusgWährTxt := WährTxt;
    ...
    local procedure OnPreSectionRoundLoop_Body19(var RoundLoop: Record Integer);
    begin
        with RoundLoop do begin
    ...
    begin
        with RoundLoop do begin
            ReportForNavSetShowOutput(("Sales Line".Type.AsInteger() <> 0) and
                                  ...
                                  /*"Sales Header"."nur kompl. Preis drucken" AND*/
    ...
    begin
        with RoundLoop do begin
            ReportForNavSetShowOutput((("Sales Line".Type = "Sales Line".Type::Item) or ("Sales Line".Type = "Sales Line".Type::"Charge (Item)")) and
                                  (not FrachtJN) and
                                  not "Sales Header"."Pos.-Zus.-Zähl-Summen drucken" and
                                  //(NOT "Sales Header"."nur kompl. Preis drucken") AND
    ...
    local procedure OnPreSectionRoundLoop_Body29(var RoundLoop: Record Integer);
    begin
        with RoundLoop do begin
            ReportForNavSetShowOutput(("Sales Line"."Line Discount %" <> 0) and
                                  not FrachtJN and not ("Sales Header"."Zeilenrabatt ausblenden" = true));
        end;
    end;

    local procedure OnPreSectionRoundLoop_Footer31(var RoundLoop: Record Integer);
    begin
        with RoundLoop do begin
    ...
    local procedure OnPreSectionRoundLoop_Footer33(var RoundLoop: Record Integer);
    begin
        with RoundLoop do begin
    ...
    local procedure OnPreSectionLetztePosZusammenzahl_Body35(var LetztePosZusammenzähl: Record Integer);
    begin
        ...
        case (dataItemId) of
            ...
            'DimensionLoop1':
                begin
                    ...
                    ReportForNavShowOutput := true;
                    OnPreSectionDimensionLoop1_Body11(DimensionLoop1);
            ...
            'RoundLoop':
                begin
                    ...
                    ReportForNavShowOutput := true;
                    OnPreSectionRoundLoop_Body19(RoundLoop);
                    ...
                    ReportForNavShowOutput := true;
                    OnPreSectionRoundLoop_Body29(RoundLoop);
                    jsonObject.Add('$Body29$Pre', ReportForNavShowOutput);
                    with RoundLoop do begin
                        ...
                        ReportForNavShowOutput := true;
                        OnPreSectionRoundLoop_TransHeader14(RoundLoop);
                        jsonObject.Add('$TransHeader14$Pre', ReportForNavShowOutput);
                        ReportForNavShowOutput := true;
                        OnPreSectionRoundLoop_Footer31(RoundLoop);
                        jsonObject.Add('$Footer31$Pre', ReportForNavShowOutput);
                        ReportForNavShowOutput := true;
                        OnPreSectionRoundLoop_Footer33(RoundLoop);
                        jsonObject.Add('$Footer33$Pre', ReportForNavShowOutput);
            ...
            'LetztePosZusammenzahl':
                begin
                    ReportForNavShowOutput := true;
                    OnPreSectionLetztePosZusammenzahl_Body35(LetztePosZusammenzähl);
                    jsonObject.Add('$Body35$Pre', ReportForNavShowOutput);
                    ReportForNavShowOutput := true;
            ...
            'TMFooter':
                begin
                    ...
                    GlobalLanguage := 1033;
                    jsonObject.Add('DataItem$TMFooter$CurrentKey$Text', TMFooter.CurrentKey);
