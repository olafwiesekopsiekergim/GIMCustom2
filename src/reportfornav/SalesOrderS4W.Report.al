...
Report 60041 "CCO Sales Order S4W"
{
    Caption = 'Sales - Order S4W';
    WordLayout = './Layouts/CCOSalesOrderS4W.docx';
    DefaultLayout = Word;
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(LieferTerminK; "Sales Header".Kundenliefertermin)
                    {
                    }
                    ...
                    column(ShiptoAddrTotal; StrSubstNo(ShipToAddr[1], ShipToAddr[2], ShipToAddr[3], ShipToAddr[4], ShipToAddr[5], ShipToAddr[6], ShipToAddr[7]))
                    {
                    }
