...
Report 60004 "CCO Sales Order"
{
    Caption = 'Sales Order';
    WordLayout = './Layouts/CCOSalesOrder.docx';
    DefaultLayout = Word;
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(SalesLineLineAmount_SalesLineInvDiscountAmount_GesKorrSumme; SalesLine."Line Amount" - GesKorrSumme)
                        {
                        ...
                        begin
                            ...
                            if (SalesLine.Type = SalesLine.Type::Item)
                               and (not PrintVereinbarung)
                               and (SalesLine."No." = '2.00.398')
                            then begin
            ...
            begin
                ...
                if PrintVereinbarung then begin
                    ...
                    Report.RunModal(50062, false, false, SalesHeader);
                end;
                // << CC
            end;
    ...
    begin
        with RoundLoop do begin
            ...
            if ReportForNavShowOutput and not "Sales Line"."Allow Line Disc." then begin
                AusgItemNo := "Sales Line"."No." + '*';
            end;
        end;
    end;
    ...
    begin
        with RoundLoop do begin
            ReportForNavSetShowOutput(ArtInfoAbm <> '');
    ...
    begin
        with RoundLoop do begin
            ReportForNavSetShowOutput(("Sales Line"."Line Discount %" <> 0) and
                                  not FrachtJN and
                                  not "Sales Header"."Zeilenrabatt ausblenden");
        end;
    end;
    ...
    local procedure OnPreSectionVATCounterLCY_Body1(var VATCounterLCY: Record Integer);
    begin
        with VATCounterLCY do begin
        end;// Autogenerated by ForNav;
    end;
    ...
    begin
        ...
        case (dataItemId) of
            ...
            'VATCounterLCY':
                begin
                    ReportForNavShowOutput := true;
                    OnPreSectionVATCounterLCY_Body1(VATCounterLCY);
