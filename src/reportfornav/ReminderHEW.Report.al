...
Report 60010 "CCO Reminder HEW"
{
    Caption = 'Reminder HEW';
    WordLayout = './Layouts/CCOReminderHEW.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Issued Reminder Header"; "Issued Reminder Header")
        {
            ...
            dataitem(Integer; Integer)
            {
                ...
                column(AnsprechCap; AnsprechCap)
                {
                ...
                column(Fax; FaxCaption)
                {
                    IncludeCaption = false;
                }
                column(Phone; PhoneCaption)
                {
                    IncludeCaption = false;
                }
                column(EMail; EMailCaption)
                {
                    IncludeCaption = false;
                }
                ...
                column(HEW001; HEW001)
                {
                }
                column(HEW002; HEW002)
                {
                }
                column(HEW003; HEW003)
                {
                }
                column(HEW004; HEW004)
                {
                }
                ...
                dataitem("Issued Reminder Line"; "Issued Reminder Line")
                {
                    ...
                    column(Anz_Skto_KuerzCaption; Anz_Skto_KuerzCaption)
                    {
                        IncludeCaption = false;
                    }
                    column(IssuedReminderLineFIELDCAPTION_NoofReminders; MahnstufeCaption)
                    {
                        IncludeCaption = false;
                    }
            ...
            begin
                ...
                //DUE
                FirmenAnschr1 := CompanyInfo.Name + ', ' + CompanyInfo."Address 2" + ', ' +
                ...
                Clear(KopfTxt);
                if ("Issued Reminder Header"."Reminder Level" = 1) then
                    KopfTxt := StrSubstNo(DUE001)
                else
                    KopfTxt := StrSubstNo(DUE002, Format("Issued Reminder Header"."Reminder Level"));
                //c/wa/300399: Währung
                ...
                if lIssuedRemLine.FindFirst then begin
                    if lCustLedgEntry.Get(lIssuedRemLine."Entry No.") then; //THEN BEGIN
    ...
    var
        ...
        PhoneCaption: label 'Telefon:';
        EMailCaption: label 'E-Mail:';
        Anz_Skto_KuerzCaption: label ' Down Payment';
        MahnstufeCaption: label ' Reminder Stage';
        AnsprechCap: label 'Your contacts:';
        HEW001: label 'Best regards';
        HEW002: label 'HANNING ELEKTRO-WERKE ';
        HEW003: label 'GmbH & Co. KG';
        HEW004: label 'i. V. Uwe Westerdorf i. V. Irene Peters';
    ...
    begin
        with "Issued Reminder Line" do begin
            ...
            DownPayment := 0;
            DownPayment := "Original Amount" - "Remaining Amount";
    ...
    local procedure OnPreSectionIssuedReminderLine2_Body21(var IssuedReminderLine2: Record "Issued Reminder Line");
    begin
        with IssuedReminderLine2 do begin
    ...
    begin
        ...
        case (dataItemId) of
            ...
            'IssuedReminderLine2':
                begin
                    ReportForNavShowOutput := true;
                    OnPreSectionIssuedReminderLine2_Body21(IssuedReminderLine2);
