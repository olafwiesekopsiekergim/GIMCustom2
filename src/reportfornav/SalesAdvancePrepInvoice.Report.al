...
Report 60019 "CCO Sales Advance Prep.Invoice"
{
    Caption = 'Sales Advance Prepayment Invoice';
    Permissions = TableData "Sales Shipment Buffer" = rimd;
    WordLayout = './Layouts/CCOSalesAdvancePrep.Invoice.docx';
    DefaultLayout = Word;
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(OrderNo_SalesInvoiceHeader; "Sales Invoice Header"."Prepayment Order No.")
                    {
                        IncludeCaption = false;
                    }
                    ...
                    column(PrepaymentOrderNo; "Sales Invoice Header"."Prepayment Order No.")
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(TotalExclVATText; TotalExclVATcpt)
                        {
                            IncludeCaption = false;
                        }
    ...
    var
        ...
        InvName: Text;
        Profo: label 'Prepayment Invoice %1';
        TotalExclVATcpt: label 'Prepayment Total';
    ...
    begin
        with Total do begin
            ReportForNavSetShowOutput(LiefInnerg_DrittlandText <> '');
        end;
    end;
