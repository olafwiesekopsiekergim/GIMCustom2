...
Report 60038 "CCO Purchase Order S4W"
{
    Caption = 'Purchase - Order S4W';
    WordLayout = './Layouts/CCOPurchaseOrderS4W.docx';
    DefaultLayout = Word;
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(UnsereKontono; "Purchase Header"."Our Account No.")
                    {
                    }
                    column(KontoNrCpt; KontoNrCpt)
                    {
                    }
                    column(ItemDrawing_Description; ItemDrawDescription)
                    {
                    ...
                    column(PurchaseHeaderfix_TerminLieferung; "Purchase Header"."CCS PR Expected Quote Date")
                    {
                        IncludeCaption = false;
                    }
                    ...
                    column(STRSUBSTNO_DUE004_PurchaseHeaderNo; StrSubstNo(StornoTXT, "Purchase Header"."No."))
                    {
                    }
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(LineAmount_PurchLine; PurchLine."Line Amount")
                        {
                        ...
                        column(PlannedReceiptDate_PurchLine; PurchLine."Planned Receipt Date")
                        {
                            IncludeCaption = false;
                        }
                        ...
                        column(LineAmount_PurchLine2; PurchLine."Line Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                            IncludeCaption = false;
                        }
                        column(InvDiscountAmount_PurchLine; -PurchLine."Inv. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Line"."Currency Code";
                            AutoFormatType = 1;
                            IncludeCaption = false;
                        }
                        column(PurchLineLineAmount_PurchLineInvDiscountAmount; PurchLine."Line Amount" - PurchLine."Inv. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                            IncludeCaption = false;
                        ...
                        column(PurchLineLineAmount_PurchLineInvDiscountAmount_VATAmount; PurchLine."Line Amount" - PurchLine."Inv. Discount Amount" + VATAmount)
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                            IncludeCaption = false;
                        ...
                        begin
                            ...
                            //			ItemDrawDescription := StrSubstNo('%1 - %2',ArtInfoZeichn,ArtInfoAbm)
                            //		  else
                            //			if (ArtInfoZeichn<>'') then
                            //			  ItemDrawDescription := ArtInfoZeichn
                            //			else
                            //			  ItemDrawDescription := ArtInfoAbm;
                            //		end;
                            //	  end;
                            // else
                            //   ItemDrawDescription := '';
                    ...
                    {
                        DataItemTableView = sorting(Number) where(Number = const(1));
                        column(ReportForNavId_122; 122) { } // Autogenerated by ForNav - Do not delete
                    ...
                    {
                        DataItemTableView = sorting(Number) where(Number = const(1));
                        column(ReportForNavId_123; 123) { } // Autogenerated by ForNav - Do not delete
                    ...
                    begin
                        ...
                        CompanyInfo.CalcFields("Picture 3");//, Logo);
                    end;
    ...
    var
        ...
        ItemDrawDescription: Text[200];
        DUE022: label 'Änderung zur Bestellung Nr. %1';
        KontoNrCpt: label 'Our Customerno.:';
    ...
    begin
        with RoundLoop do begin
            ReportForNavSetShowOutput("Purchase Line".Type = "Purchase Line".Type::"Charge (Item)");
        end;
    end;
    ...
    local procedure OnPreSectionRoundLoop_Footer25(var RoundLoop: Record Integer);
    begin
        with RoundLoop do begin
    ...
    local procedure OnPreSectionRoundLoop_Footer26(var RoundLoop: Record Integer);
    begin
        with RoundLoop do begin
    ...
    local procedure OnPreSectionRoundLoop_Footer27(var RoundLoop: Record Integer);
    begin
        with RoundLoop do begin
    ...
    local procedure OnPreSectionTotal3_Body42(var Total3: Record Integer);
    begin
    ...
    begin
        ...
        case (dataItemId) of
            ...
            'RoundLoop':
                begin
                    ...
                    with RoundLoop do begin
                        ...
                        ReportForNavShowOutput := true;
                        OnPreSectionRoundLoop_Footer25(RoundLoop);
                        jsonObject.Add('$Footer25$Pre', ReportForNavShowOutput);
                        ReportForNavShowOutput := true;
                        OnPreSectionRoundLoop_Footer26(RoundLoop);
                        jsonObject.Add('$Footer26$Pre', ReportForNavShowOutput);
                        ReportForNavShowOutput := true;
                        OnPreSectionRoundLoop_Footer27(RoundLoop);
            ...
            'Total3':
                begin
                    ReportForNavShowOutput := true;
                    OnPreSectionTotal3_Body42(Total3);
                    jsonObject.Add('$Body42$Pre', ReportForNavShowOutput);
                end;
        end;
