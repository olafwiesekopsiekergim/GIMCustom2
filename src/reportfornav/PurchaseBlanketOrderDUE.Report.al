...
Report 60037 "CCO Purchase Blanket Order DUE"
{
    Caption = 'Purchase - Blanket Order DUE';
    WordLayout = './Layouts/CCOPurchaseBlanketOrderDUE.docx';
    DefaultLayout = Word;
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(STRSUBSTNO_DUE004_PurchaseHeaderNo; StrSubstNo(DUE004, "Purchase Header"."No."))
                    {
                        IncludeCaption = false;
                    }
                    ...
                    dataitem(TMFooter; Integer)
                    {
                        DataItemLinkReference = PageLoop;
                        DataItemTableView = sorting(Number);
                        column(ReportForNavId_121; 121) { } // Autogenerated by ForNav - Do not delete
    ...
    local procedure OnPreSectionTotal3_Body40(var Total3: Record Integer);
    begin
    ...
    begin
        ...
        case (dataItemId) of
            ...
            'Total3':
                begin
                    ReportForNavShowOutput := true;
                    OnPreSectionTotal3_Body40(Total3);
                    jsonObject.Add('$Body40$Pre', ReportForNavShowOutput);
                end;
        end;
