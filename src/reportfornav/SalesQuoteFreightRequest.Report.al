...
Report 60043 "CCO Sales Quote FreightRequest"
{
    Caption = 'Sales Quote Freight Request DUE';
    WordLayout = './Layouts/CCOSalesQuoteFreightRequest.docx';
    DefaultLayout = Word;
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(GewichtCaption; GewichtCaption)
                        {
                            IncludeCaption = false;
                        }
                        column(SalesLine_ZeilenGewicht; "Sales Line"."Line Gross Weight")
                        {
                            IncludeCaption = false;
                        }
            ...
            begin
                ...
                /*ELSE
							...
							LieferTerminK := "Sales Header".LieferJahrKW;
							LieferTerminKopf();*/
