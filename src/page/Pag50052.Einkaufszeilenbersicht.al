page 50052 "Einkaufszeilen Übersicht"
{
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Delivery Tolerance Code"; "Delivery Tolerance Code")
                {
                }
                field("Checklist No."; "Checklist No.")
                {
                }
                field("Primary Demand Type"; "Primary Demand Type")
                {
                }
                field("Primary Demand Subtype"; "Primary Demand Subtype")
                {
                }
                field("Primary Demand ID"; "Primary Demand ID")
                {
                }
                field("Primary Demand Batch Name"; "Primary Demand Batch Name")
                {
                }
                field("Prim. Demand Prod. Order Line"; "Prim. Demand Prod. Order Line")
                {
                }
                field("Primary Demand Ref. No."; "Primary Demand Ref. No.")
                {
                }
                field("Primary Demand Customer No."; "Primary Demand Customer No.")
                {
                }
                field("Created by KANBAN"; "Created by KANBAN")
                {
                }
                ...
                field("Rounding Line"; "Rounding Line")
                {
                }
                field("No. of Units"; "No. of Units")
                {
                }
                field("Assert Purchase Order Quantity"; "Assert Purchase Order Quantity")
                {
                }
                field("Arrival Date"; "Arrival Date")
                {
                }
                field("Item Fixed Asset Purchase"; "Item Fixed Asset Purchase")
                {
                }
                field("Item Fixed Asset No."; "Item Fixed Asset No.")
                {
                }
                field("Rate Code"; "Rate Code")
                {
                }
                field("Qty. to Return"; "Qty. to Return")
                {
                }
                field("Qty. to Return (Base)"; "Qty. to Return (Base)")
                {
                }
                field("Qty. Returned"; "Qty. Returned")
                {
                }
                field("Qty. Returned (Base)"; "Qty. Returned (Base)")
                {
                }
                field(WBS; WBS)
                {
                }
                field("Total Dir.Cost Rem. PO (LCY)"; "Total Dir.Cost Rem. PO (LCY)")
                {
                }
            }
        }
